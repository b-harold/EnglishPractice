...
(function () {
    ...
    // State - will attempt to load from localStorage or fetch from phrases.json
    let phrases = [];
    ...
    function init() {
        ...
        // Otherwise fetch from phrases.json
        fetch('../data/phrases.json')
            ...
            .catch(error => {
                console.error('Failed to fetch phrases from phrases.json:', error);
                renderPhrases();
            });
    }
